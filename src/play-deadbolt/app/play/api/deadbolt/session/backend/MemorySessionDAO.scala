...
class MemorySessionDAO extends SessionDAO {
  ...
  protected def doReadSession(sessionId: Serializable): Session = sessions.getOrElse(sessionId,null)
  ...
  override def readSession(sessionId: Serializable): Session = null
